...
import { fetchAccountNfts } from 'utils/xrpl.api';
...
function Nfts(props) {
    ...
    useEffect(() => {
        if (address) {
            getAccountNftData(address);
        }
    }, [
        address,
    ]);

    const getAccountNftData = async () => {
        const response = await fetchAccountNfts(address);
    };
                            ...
                            <div className="nft-item">
                                ...
                                <div className="meta-info">
                                    ...
                                    >
                                        ...
                                        <span className="number-like"> 3432</span>
                                    </Link> */}
                                </div>
                                <div className="card-bottom style-explode">
                                    <div className="price">
                                        <span className="icon-xrp"></span>
