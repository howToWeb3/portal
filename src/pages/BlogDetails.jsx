                        ...
                        <div className="bloglist__main">
                            <div className="list details">
                                ...
                                <div className="content-d">
                                    ...
                                    <div className="main">
                                        <p className="boild">
                                            The non-fungible tokens (NFTs) owners have zero intellectual property
                                            ownership of their content and only one NFT collection in the top 25
                                            platforms by market capitalisation has attempted to confer intellectual
                                            property rights to the purchasers of digital arts, says a report.
                                        </p>
                                        <div className="image">
                                            <img
                                                src={img1}
                                        ...
                                        <p className="mb-15">
                                            Most NFT operators "appear to have misled NFT purchasers" about the extent
                                            of their rights.
                                        </p>
                                        <p className="mb-15">
                                            The Creative Commons license, seen as a solution to the restrictive licenses
                                            used by most projects, "renders NFT ownership obsolete from a legal
                                            perspective as it moves the intellectual property fully into the public
                                            domain, making it impossible for NFT holders to defend their ownership
                                            rights in court," according to the report by Galaxy Digital Research.
                                        </p>
                                        <p className="mb-15">
                                            The report mentioned that without improvements in the on-chain
                                            representation and transfer of intellectual property rights from NFT issuers
                                            to NFT token holders, the expansive vision of Web3 will remain unrealised.
                                        </p>
                                        <p className="mb-15">
                                            The report analysed major NFT projects, like the Yuga Labs project Bored Ape
                                            Yacht Club (BAYC), Gary Vaynerchuk's VeeFriends, World of Women, and social
                                            platforms Decentraland and Sandbox.
                                        </p>
                                        <p className="mb-15">
                                            It found that only the 'World of Women' (WoW) NFT collection differentiates
                                            itself from all the other top 25 NFT projects by being the only to attempt
                                            to transfer full IP rights to NFT holders.
                                        </p>
                                        <p className="mb-15">
                                            'World of Women' attempts this through the provision of a novel copyright
                                            assignment agreement.
                                        </p>
                                        <p className="mb-15">
                                            "Under this copyright assignment agreement, WoW attempts to create a
                                            governance structure in which the copyright of each WoW NFT 'runs with' the
                                            NFT, such that whoever owns the NFT owns the copyright," the report
                                            mentioned.
                                        </p>
                                        <p className="mb-15">NFT holders should fight for their IP rights.</p>
                                        <p>
                                            "As NFTs are still in their infancy stage, it is critical for the NFT
                                            community to begin working on a framework to properly give out IP rights to
                                            users before mass adoption," the findings showed.
                                        </p>
                                        ...
                                        <div className="bottom">
                                            ...
                                            <ul className="list-tag">
                                                <li>
                                                    <Link to="/blog-details">nfts</Link>
                                                </li>
                                                <li>
                                                    <Link to="/blog-details">crypto</Link>
                                                </li>
                                                <li>
                                                    <Link to="/blog-details">cyfonii</Link>
                                                </li>
                                                <li>
                                                    <Link to="/blog-details">collection</Link>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                        ...
                                        <div className="ac prev">
                                            ...
                                            <div>
                                                ...
                                                <Link
                                                    ...
                                                    className="title"
                                                >
                                                    OpenSea NFT Marketplace to Solely Support Ethereum’s Upgraded...
                                                </Link>
                                            </div>
                                        </div>
                                        <div className="ac next">
                                            ...
                                            <div>
                                                ...
                                                <Link
                                                    ...
                                                    className="title"
                                                >
                                                    MTV Music Awards to See Eminem, Snoop Dogg Perform in Bored...
                                                </Link>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div className="comment-box s1">
                                            ...
                                            <div className="info">
                                                ...
                                                <p className="text">
                                                    ...
                                                    nibh interdum, quis dignissim neque scelerisque.
                                                </p>
                                                <Link to="#">Reply</Link>
                                            </div>
                                        </div>
